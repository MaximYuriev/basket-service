...
class BasketService:
    ...
    async def add_product_on_basket(self, product: AddProductDTO, basket_id: uuid.UUID) -> None:
    ...
    async def update_product_on_basket(self, update_product: UpdateProductDTO, basket_id: uuid.UUID) -> None:
        basket = await self.get_basket(basket_id)
